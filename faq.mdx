...
<AccordionGroup>
  ...
  <Accordion title="How to verify my Apple Developer Account is Active">
    Follow our step-by-step guide with a quick checklist to verify your Apple Developer Account is active and ready to publish apps: [Verify Your Apple Developer Account is Active](/builder/mobile/verify-apple-developer-account).
  </Accordion>
