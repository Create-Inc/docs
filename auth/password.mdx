...
<CardGroup cols={2}>
  <Card title="Enable User Accounts" icon="user-check">
    Prompt Anything to add users, or turn on from logo menu > Settings > User Accounts
  </Card>
  <Card title="Enable Email/Password" icon="key">
    By default, email/password is enabled. You can turn it off and prompt Anything to remove it.
  </Card>
