...
<Check>
  A Anything project with [User Accounts](/builder/user-accounts) turned on
</Check>
...
<CardGroup cols={2}>
  ...
  <Card title="Add to Anything" icon="plug">
    Add your X App's Client ID/Secret in Anything
  </Card>
...
<div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
  <iframe 
    ...
    src="https://www.loom.com/embed/9e22bc2239614b0daa57d62d1a0f5977?sid=35c1933c-dfe0-430c-913f-26863d44dbf1" 
    frameborder="0" 
...
<Steps>
  <Step title="Access X Developer Portal">
    ...
    <img src="/images/auth/x/1-developerxapps.png" />
  </Step>
...
<Steps>
  ...
  <Step title="Enable Login with X">
    ...
    3. Turn it on
    <img src="/images/auth/x/18-enabletwitter.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
  ...
  <Step title="Add Sign In UI">
    ...
    <img src="/images/auth/x/19-promptcreate.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
