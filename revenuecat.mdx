...
Submit your app to Apple via our system to test in TestFlight. Test purchases work in TestFlight's production-like environment. See [Publishing to iOS App Store](/builder/mobile/publishing-ios) for setup instructions.
