...
In this step, you're connecting at the project level, from our system to RevenueCat and App Store Connect. If you don't yet have projects in those systems to link to, you can create them in this menu and link them.
