...
<Warning>
  **Important for Mobile Apps:** Per Apple's App Store guidelines, Google and Facebook SSO cannot be present in iOS mobile builds until the "Sign in with Apple" feature is released. Do not implement Google or Facebook authentication in mobile apps until Sign in with Apple is available.
</Warning>
