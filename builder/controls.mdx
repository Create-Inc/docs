...
- **Modes**: Toggle between [Demo, Code and Preview](/Modes)
...
Download your project's source code for external development or backup.

Navigate to the Code tab and click Download Project to get the Next.js project.
