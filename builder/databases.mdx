...
<Frame caption="Database Overview Video">
  <iframe
    width="100%"
    height="400"
...
<Tip>
  Always describe both what data you want to store AND how you want to use it. This helps Anything build the right database structure, Functions, and UI.
</Tip>

<Tip>
  The more specific you are in your prompt, the better Anything can help.

  If you describe something at a high level, "make a todo app", Anything will guess what fields each todo should have.

  If you describe what you want in detail, "make a todo app with a title, due date, and priority field", Anything will ensure each todo has those fields.
</Tip>

## View and edit data

Anything includes a built-in database viewer for manual edits to your data. You can quickly verify that data is being stored correctly when you use your application.
...
Anything maintains separate test and live databases for each project:
...
When you publish your application, Anything automatically:
...
<Warn>
  ...
  * Anything will warn you about this conflict on publish. If you publish, it will remove the existing phone numbers.
  ...
  Anything warns you about destructive changes before you publish to protect your live data.
</Warn>
...
* Anything will modify the database to match
...
* Ask Anything to fix the specific error
...
* Anything will update the code to properly wire everything together

<Tip>
  For any errors you encounter, you can paste them directly into Anything's chat. It often recognizes specific error patterns and knows how to fix them.
</Tip>

## Reset database structure

When you publish your application, Anything pushes your test database structure to your live database. If you continue making changes to your test database structure in the builder and don't like the changes, you can reset to the structure of your last published version.
...
<Info>
  If you had data in the database you removed, you can ask Anything to update your single database with tables that support all of your use cases. It will update the remaining database to have multiple tables instead of having multiple databases.
</Info>

<Tip>
  Before removing a database, make sure you understand which application features are using it. Anything will attempt to warn you if removing a database would break functionality.
</Tip>

## Use existing databases

Anything will automatically create a new database for your project. However, there are some scenarios where you might want to use an existing database for a new project:
...
3. Prompt Anything on what you want to build with the database chip in the chat 
...
<AccordionGroup>
  <Accordion title="Will this scale?">
    Yes. Anything's built-in databases are designed to scale. Under the hood, it's PostgreSQL, which is powerful and scalable. We partner with [Neon](https://neon.tech) to autoscale your database as your application grows.
  </Accordion>
  ...
  <Accordion title="Can I write custom queries?">
    Anything handles making queries to your database automatically. For custom queries, create a [Function](/builder/functions) and describe what you need. You can then use your Function. Or use the built-in SQL editor in the database viewer.
  </Accordion>

  <Accordion title="I have a legacy database from an app built prior to February 2025" defaultOpen={false}>
    We still have documentation for you, [linked here.](/builder/databases-v1)
  </Accordion>
...
Anything handles the technical details of your database, but understanding some key concepts can help you work more effectively.
...
| **SQL** | The language databases understand | Anything writes this for you! |
| **Migration** | Changes to your database structure | Adding a "phone" field to Users table |

<Tip>
  Don't worry about memorizing these! Just describe what data you want to store and how you want to use it - Anything handles the technical implementation.
</Tip>
