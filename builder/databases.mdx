...
Anything provides a complete DB for every project, a development and a production database. As you chat with Anything, it handles all database details - from designing the structure to writing the code that enables your application to save and retrieve data.
...
<div style={{
  ...
  <h3 style={{ marginTop: 0, marginBottom: '16px', color: '#856404', fontSize: '20px', fontWeight: 'bold' }}>
    🎓 DB 101: Why is there a development and a production db?
  </h3>
  <p style={{ marginBottom: '12px', color: '#856404', fontSize: '16px', lineHeight: '1.6' }}>
    Anything maintains two separate databases for each project: Test (development) and Live (production). They are intentionally separated as a best practice to protect your production data while you develop and test changes internally.
  </p>
  <p style={{ marginBottom: '12px', color: '#856404', fontSize: '16px', lineHeight: '1.6' }}>
    <strong>Schema vs. Data:</strong> When you publish, Anything pushes your database schema (structure - tables and fields) to production, but data stays separate. The two databases share the same structure, but they do not share data.
  </p>
  <p style={{ marginBottom: '12px', color: '#856404', fontSize: '16px', lineHeight: '1.6' }}>
    <strong>Real world example:</strong> If you build a blog creation app in development and create blog posts there, those posts will not appear in your production app. This is intentional! Here's the process flow:
  </p>
  <ol style={{ marginBottom: '12px', color: '#856404', fontSize: '16px', lineHeight: '1.6', paddingLeft: '24px' }}>
    <li style={{ marginBottom: '8px' }}>Build a blog creation tool in development</li>
    <li style={{ marginBottom: '8px' }}>Test that tool in development</li>
    <li style={{ marginBottom: '8px' }}>Test a blog posting (that will only appear in dev)</li>
    <li style={{ marginBottom: '8px' }}>Publish the build</li>
    <li style={{ marginBottom: '8px' }}>Use the blog posting function in production (e.g., app.com/blog-creation-tool) to create blog posts that appear for public users + store to your production DB</li>
  </ol>
  <p style={{ marginBottom: 0, color: '#856404', fontSize: '16px', lineHeight: '1.6' }}>
    Development is your "internal software mudroom" where you test features; production is where your users interact with real data.
  </p>
</div>
...
Create maintains separate development and production databases for each project:
...
* Access your production database from the builder
