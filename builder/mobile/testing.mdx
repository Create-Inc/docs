...
<div style={{position: 'relative', paddingBottom: '56.25%', height: 0}}>
  <iframe
    src="https://www.loom.com/embed/4473d72290e24af3b11f4c22e148ae07?sid=29530ddc-7e9a-4711-b2de-9aa8c0d77756"
    frameBorder="0"
    webkitAllowFullScreen
    mozAllowFullScreen
    allowFullScreen
...
## Apple App Compliance Check

Before submitting your app to the App Store, ensure it meets Apple's guidelines and requirements with our automated tool.

1. **Download your project code** - [Learn how to export your code](https://localhost:3000/builder/controls#export-code)

2. **Upload your project** - Head to [https://www.createanything.com/app-store](https://www.createanything.com/app-store) and upload your project zip file

3. **Review** - We will run a compliance check for you with detailed results
