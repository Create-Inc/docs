...
<Note>
  If you have the [Anything iOS App](/builder/anything-ios) installed, it will automatically take over app preview duties from Expo Go when testing your mobile apps on iOS devices. The Anything iOS App provides a native preview experience directly on your device.
</Note>
