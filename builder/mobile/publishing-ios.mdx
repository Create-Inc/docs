...
<Steps>
  <Step title="Prepare Your App">
    1. Use our automated App Store Review system by clicking Publish in your mobile project and selecting "App Store Review"
    ...
    2. Obtain your [Apple Developer Account](https://developer.apple.com/account) and [verify it's active](/builder/mobile/verify-apple-developer-account)

       <Warning>
         <u>New Apple Developer Accounts typically take 3 days from purchase to process</u> and may require ID verification to finalize. Pay close attention to your email as they will update you or ask for further information there. \
         \
...
- [Verify Apple Developer Account](/builder/mobile/verify-apple-developer-account) - Verify your account is active
