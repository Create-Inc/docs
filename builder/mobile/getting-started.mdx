...
<Steps>
  ...
  <Step title="Build Your Full-stack app">
    You can use Anything's built-in [databases](/builder/databases), [functions](/builder/functions), [auth](/builder/user-accounts), and [payments](/revenuecat) to build full-stack apps. Just describe what you want the app to do and Anything will add the right functionality.
