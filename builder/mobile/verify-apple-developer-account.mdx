...
When publishing through our system, if you belong to multiple Developer Teams or Providers, the **Team** and **Provider** must match for the build to publish successfully. This ensures the signing identity aligns with the provider entity in App Store Connect.

**What are Team and Provider?**
...
1. **Find your Team information:**
   ...
   - Note your **Team Name** and **Team ID** (10-character identifier)

2. **Check your Provider in App Store Connect:**
   - In [App Store Connect](https://appstoreconnect.apple.com), the Provider name should match your Team Name or Team ID
...
- **Check your Team ID**: Go to [developer.apple.com/account](https://developer.apple.com/account) → Membership and note your Team ID
