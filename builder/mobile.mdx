...
- **Full stack** - Built-in [databases](/builder/databases), [functions](/builder/functions), [auth](/builder/user-accounts), [storage](/builder/uploads), and [payments](/staging/revenuecat)
...
**AI Coaching App**
- Chat with AI coach via text, track progress with charts, charge for Pro features, get daily reminders via notifications, store goals securely
...
<AccordionGroup>
  ...
  <Accordion title="How do I add payments to my mobile app?">
    iOS mobile apps must use [RevenueCat (Beta)](/staging/revenuecat) for all payments and subscriptions. RevenueCat handles in-app purchases, subscriptions, and paywalls for iOS apps. Web apps use [Stripe](/stripe) for payments.
  </Accordion>
</AccordionGroup>
