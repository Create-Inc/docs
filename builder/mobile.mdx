...
<AccordionGroup>
  ...
  <Accordion title="Can I use Stripe in an iOS app? I thought Apple banned third party payments">
    Yes! Apple has revised their App Store policy to allow third-party payment systems like Stripe in the US App Store. As of 2024, Apple now permits developers to use alternative payment processors for digital goods and services, including Stripe integration, specifically for US-based apps. This change came after regulatory pressure and legal challenges to Apple's previous restrictions. You can now build iOS apps with Stripe payments using Anything's built-in [Stripe integration](/stripe) without worrying about App Store rejection in the US. Note that this policy change currently applies to the US App Store only. For the latest details, see [Apple's policy updates](https://www.techspot.com/news/107775-apple-revises-app-store-policy-allows-third-party.html).
  </Accordion>
</AccordionGroup>
