...
<AccordionGroup>
  ...
  <Accordion title="Can I use Stripe in an iOS app?">
    It depends on what you're selling! Apple's App Store guidelines are specific about payment methods:

    **You must use Apple's In-App Purchase (IAP) for:**
    - Digital goods and services consumed within the app (premium features, in-app currencies, digital subscriptions)

    **You can use third-party payments like Stripe for:**
    - Physical goods and services (e-commerce, food delivery, ride-hailing)
    - Person-to-person services (tutoring, fitness training, consulting)

    **Recent US Changes (2024):**
    Apple now allows US developers to include external payment links, but with strict requirements and Apple still takes 12-27% commission. This applies to the US App Store only.

    For most Anything apps selling physical products or services, you can use Stripe. Apple Payment and further ecosystem additions are in progress for our mobile builder.
  </Accordion>
</AccordionGroup>
