---
title: "Stripe"
description: "Add Stripe payments to your web app"
version: "2.0"
---
...
Anything's built-in Stripe integration lets you easily add payments to your web app without complex setup. You can collect payments for:
...
<Note>
  **Mobile Apps**: Stripe is for web apps only. iOS mobile apps must use [RevenueCat (Beta)](/staging/revenuecat) for all payments and subscriptions.
</Note>
