...
![Create Start](/images/createstart.gif)
...
3. **[Test](/builder/mobile/testing) and deploy** - [Preview](/Modes#view-modes) your app and publish when ready
...
- **[Integrations](/builder/integrations)** - "Connect to [Stripe](/stripe) for payments" or "Add email notifications"
...
- **Use [Discussion Mode](/Modes#discussion-mode)** - Plan your changes and integrations in Discussion Mode first to avoid unnecessary iterations
...
- **[Test](/builder/mobile/testing) in [Preview Mode](/Modes#view-modes)** - Use preview mode to test edits before moving on to other features
- **Focus on one issue at a time** - Address problems individually rather than trying to fix multiple issues in one message
- **Learn to [triage effectively](/support/help#how-to-triage)** - Watch our triage guide to efficiently troubleshoot and debug issues

<Tip>
  We recommend using [Google Chrome](https://www.google.com/chrome/) for the best experience.
</Tip>

## Publishing and deployment

<Tip>
  [Preview](/Modes#view-modes) and [test](/builder/mobile/testing) your application before publishing. Only publish when ready for production use.
</Tip>
