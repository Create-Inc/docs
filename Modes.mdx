...
- **[Thinking Mode](#thinking-mode)** - Allows the AI to generate the highest quality results and when necessary review external resources to ensure accuracy.
...
- **[Max](/builder/max)** - Max is our premier agent, with the highest level of capability and performance available. Max is an autonomous software engineer that builds, tests, and fixes your applications automatically. Give it a goal, and Max will work through your app like a real user, writing code and tests until the task is complete.
