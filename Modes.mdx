...
- **Auto** - Intelligently chooses the best model for you based on the tasks given
...
- **Max** - An autonomous software engineer that builds, tests, and fixes your applications automatically by seeing and using your app like a human
